...
$H_1:\mu_{\text{Caucassian}} \neq \mu_{\text{African American}} \neq \mu_{\text{Native American}} \neq \mu_{\text{Asian}} \neq \mu_{\text{Hispanic}}$
...
A Chi Square test of independence suggest that among young adult smokers, those with past year nicotine dependence were more likely to have experiences major depression in thier lifetime (`r T1[1, 2]*100`%) compared to those withou past year nicotine dependence (`r T1[2, 2]*100`%), $\chi^2 = `r CR$stat`$, 1 df, *p* < 0.0001.
